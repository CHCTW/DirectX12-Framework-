...
void Camera::frustumPlaneCal()
{
	...
	mViewProjection.mFrustumPlane[FRUSTUM_PLANE_LEFT].x = combined[0][3] + combined[0][0];
	mViewProjection.mFrustumPlane[FRUSTUM_PLANE_LEFT].y = combined[1][3] + combined[1][0];
	mViewProjection.mFrustumPlane[FRUSTUM_PLANE_LEFT].z = combined[2][3] + combined[2][0];
	mViewProjection.mFrustumPlane[FRUSTUM_PLANE_LEFT].w = combined[3][3] + combined[3][0];
