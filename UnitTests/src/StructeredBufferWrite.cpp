...
void loadAsset()
{
	...
	cmdlist.resourceBarrier(structerBuffer, D3D12_RESOURCE_STATE_UNORDERED_ACCESS, D3D12_RESOURCE_STATE_COPY_DEST);
	...
	cmdlist.resourceBarrier(structerBuffer, D3D12_RESOURCE_STATE_COPY_DEST, D3D12_RESOURCE_STATE_GENERIC_READ);
	cmdlist.close();
...
void rendscene()
{
	...
	cmdlist.resourceBarrier(structerBuffer, D3D12_RESOURCE_STATE_GENERIC_READ, D3D12_RESOURCE_STATE_UNORDERED_ACCESS); // update position of the position of the triangle
	cmdlist.dispatch(1, 1, 1);
	cmdlist.resourceBarrier(structerBuffer, D3D12_RESOURCE_STATE_UNORDERED_ACCESS, D3D12_RESOURCE_STATE_GENERIC_READ);
